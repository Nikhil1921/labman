                ...
                <div class="page-sidebar">
                    <div class="sidebar custom-scrollbar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li>
                                <?= anchor(admin('tests'), '<i data-feather="file-text"></i><span> Tests</span>', 'class="sidebar-header '.($name === 'tests' ? 'active' : '').'"') ?>
                            </li>
                            <li>
                                <?= anchor(admin('doctors'), '<i data-feather="users"></i><span> Doctors</span>', 'class="sidebar-header '.($name === 'doctors' ? 'active' : '').'"') ?>
                            </li>
                            <li>
                                <?= anchor(admin('details'), '<i data-feather="users"></i><span> Lab details</span>', 'class="sidebar-header '.($name === 'details' ? 'active' : '').'"') ?>
                            </li>
                            <li>
