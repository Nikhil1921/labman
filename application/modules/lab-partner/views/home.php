                        ...
                        <div class="media">
                            <div class="media-body">
                                <h5 class="mt-0 mb-0 f-w-600">
                                    <span class="counter"><?= $this->main->counter('orders', ['lab_id' => $this->session->auth, 'status' => $status]) ?></span>
                                </h5>
                                <p><?= $status ?> Order</p>
                            </div>
            ...
            <div class="card-body">
                <div class="chart-widget-dashboard">
                    <div class="media">
                        <div class="media-body">
                            <h5 class="mt-0 mb-0 f-w-600">
                                <span class="counter"><?= $this->main->counter('orders', ['lab_id' => $this->session->auth]) ?></span>
                            </h5>
                            <p>Total Order</p>
                        </div>
                        <i class="fa fa-file-text-o fa-2x"></i>
